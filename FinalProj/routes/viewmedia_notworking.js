            ...
            request(urlm, function (error, response, body) { 
             ...
             // read all the data in base64 format string 
                               ...
                               db.close();
                                  ...
                                  // wrapmedia(res,req,db,results,index+1);
                                                });
                                            });
                                        });
                                    });
...
function wrapmedia(res,req,db,results,index){
...
//     return;
// } 
var fileId = results[index].MEDIA_ID;
